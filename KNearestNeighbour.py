...
precisionScoreTest = precision_score(test_labels,test_labels_pred,average='macro')
recallScoreTest = recall_score(test_labels,test_labels_pred,average='macro')
f1ScoreTest = f1_score(test_labels,test_labels_pred,average='macro')
